...
const SearchNamesUseCase_1 = require("../../application/SearchNamesUseCase");
const FileNamesRepository_1 = require("../repositories/FileNamesRepository");
async function main() {
    ...
    const repository = new FileNamesRepository_1.FileNamesRepository("./data/nombres.txt");
    const searchService = new SearchNamesUseCase_1.SearchNamesUseCase(repository);
    try {
